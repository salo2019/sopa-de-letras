    ...
    def verificar(self,p):
            ...
            if (wiki[1]==True and pattern[1]==True):
                if wiki[0]!=pattern[0]:
                    ...
                    # la palabra se encuentra en pattern como (pattern[0]) y en wiki como (wiki[0])
                    #LINEA NUEVA
                    msj_reporte="{} se encuentra en wikitionary como {} y en pattern como {}, se toma la clasificacion de wikitionary.".format(p,wiki[0],pattern[0])
                    #print(msj_reporte)
                ...
                msj_reporte= "{} no se encuentra en wikitionary pero si en pattern como {}.".format(p,pattern[0])
                #print(msj_reporte)
                self.reporte(msj_reporte)
                #EL USUARIO TIENE LA OPCION DE ELEGIR LA DEFINICION DE LA PALABRA
                diseñoo=[
